...
export const Socials = () => {
  ...
  const socials = [
    ...
    },
    {
      name: 'Twitch',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 2400 2800">
    ...
    },
    {
      name: 'Discord',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 126.644 96">
    ...
    },
    {
      name: 'Docker',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 756.26 596.9">
  ...
  return (
    ...
    >
      <div className="px-4 w-full">
        <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center">Socials</h2>
        <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-6 flex-wrap gap-4 w-full">
          {socials.map((social) => (
            <a
              key={social.name}
              href={social.link}
